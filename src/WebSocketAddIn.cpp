...
WebSocketAddIn::WebSocketAddIn() {
    ...
    AddMethod(L"Add", L"Сложить", this, &WebSocketAddIn::add);
    AddMethod(L"Message", L"Сообщить", this, &WebSocketAddIn::message);
    AddMethod(L"CurrentDate", L"ТекущаяДата", this, &WebSocketAddIn::currentDate);
    AddMethod(L"Assign", L"Присвоить", this, &WebSocketAddIn::assign);
    AddMethod(L"SamplePropertyValue", L"ЗначениеСвойстваОбразца", this, &WebSocketAddIn::samplePropertyValue);
    ...
    //        def_args.insert({0, 5});
    //        AddMethod(u"Sleep", u"Ожидать", this, &WebSocketAddIn::sleep, std::move(def_args));
    //
    AddMethod(L"Sleep", L"Ожидать", this, &WebSocketAddIn::sleep, {{0, 5}});
...
variant_t WebSocketAddIn::add(const variant_t &a, const variant_t &b) {
...
void WebSocketAddIn::message(const variant_t &msg) {
...
void WebSocketAddIn::sleep(const variant_t &delay) {
    using namespace std;
